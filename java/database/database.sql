...
VALUES
	(1, 1, 30, 'Paper', 2, 'Definitely good for sleepy time.', '2022-01-22 19:10:25', 10),
	(1, 2, 30, 'Paper', 1, '','2022-01-23 17:10:21', 10),
	(1, 5, 60, 'Digital', 1, '','2022-01-23 13:25:25', 20),
	(1, 3, 60, 'Paper', 2, '','2022-01-23 14:30:25', 20),
	(1, 6, 90, 'Digital', 3, '','2022-01-24 15:40:25', 30),
	(1, 4, 90, 'Paper', 1, '','2022-01-24 16:10:25', 30),
	(1, 8, 30, 'Paper', 1, '','2022-01-24 17:10:25', 10),
	(1, 9, 60, 'Paper', 5, '','2022-01-24 18:10:25', 20),
	(1, 7, 60, 'Read-Aloud', 2, '','2022-01-25 19:10:25', 20),
    (1, 14, 90, 'Read-Aloud', 3, '','2022-01-25 11:10:25', 30),
    (1, 13, 90, 'Digital', 1, '','2022-01-25 12:10:25', 30),
    (1, 12, 30, 'Read-Aloud', 1, '','2022-01-25 13:10:25', 10),
    (1, 11, 60, 'Read-Aloud', 2, '','2022-01-25 14:10:25', 20),
    (1, 10, 90, 'Paper', 3, '','2022-01-26 15:10:25', 30),
    (1, 15, 90, 'Audiobook', 1, '','2022-01-26 16:10:25', 30),
    (1, 17, 30, 'Audiobook', 1, '','2022-01-26 17:10:25', 10),
    (1, 18, 30, 'Read-Aloud', 1, '','2022-01-26 18:10:25', 10),
    (1, 16, 30, 'Read-Aloud', 1, 'Definitely for older kids with difficult vocabulary and deep concepts.', '2022-01-26 19:10:25', 10),
	(2, 7, 60, 'Audiobook', 2, '','2022-01-26 11:10:25', 20),
    (2, 14, 90, 'Paper', 3, '','2022-01-27 12:10:25', 30),
    (2, 13, 90, 'Paper', 1, '','2022-01-27 13:10:25', 30),
    (2, 12, 30, 'Audiobook', 1, '','2022-01-27 14:10:25', 10),
    (2, 11, 60, 'Digital', 2, '','2022-01-27 15:10:25', 20),
    (2, 10, 90, 'Paper', 3, '','2022-01-27 16:10:25', 30),
    (2, 15, 90, 'Paper', 1, '','2022-01-27 17:10:25', 30),
    (2, 17, 30, 'Digital', 1,  '', '2022-01-28 18:10:25', 10),
    (2, 18, 30, 'Read-Aloud', 1, '','2022-01-28 19:10:25', 10),
    (2, 16, 30, 'Read-Aloud', 1, '', '2022-01-28 11:10:25', 10),
	(3, 1, 30, 'Paper', 2, 'Zonked right out.','2022-01-28 12:10:25', 10),
	(3, 2, 30, 'Paper', 1, '','2022-01-29 13:10:25', 10),
	(3, 5, 60, 'Paper', 1,  'What a wordy book!','2022-01-29 14:10:25', 20),
	(3, 3, 60, 'Paper', 2, '','2022-01-29 15:10:25', 20),
	(3, 6, 90, 'Digital', 3,  '','2022-01-29 16:10:25', 30),
	(3, 4, 90, 'Audiobook', 1, '', '2022-01-29 17:10:25',30),
	(3, 8, 30, 'Paper', 1, '','2022-01-29 18:10:25', 10),
	(3, 9, 60, 'Paper', 5, 'A favorite for sure.', '2022-01-30 19:10:25', 20),
	(3, 7, 60, 'Paper', 2, '','2022-01-30 12:10:25', 20),
    (3, 14, 90, 'Audiobook', 3,  '', '2022-01-30 13:10:25',30),
	(8, 1, 30, 'Paper', 2,  'Definitely good for sleepy time.','2022-01-30 19:10:25', 10),
	(6, 2, 30, 'Audiobook', 1,  '','2022-01-30 14:10:25', 10),
	(7, 5, 60, 'Audiobook', 1,  'Why are the words so boring?','2022-01-30 19:10:25', 20),
	(5, 3, 60, 'Audiobook', 2,  '','2022-02-01 15:10:25', 20),
	(4, 6, 90, 'Digital', 3,  '', '2022-02-01 16:10:25',30),
	(5, 4, 90, 'Audiobook', 1,  '','2022-02-01 17:10:25', 30),
	(4, 8, 30, 'Read-Aloud', 1,  '','2022-02-01 18:10:25', 10),
	(5, 9, 60, 'Digital', 5, 'Lets read this one again and again','2022-02-01 19:10:25', 20),
	(4, 7, 60, 'Audiobook', 2, '', '2022-02-02 12:10:25',20),
    (5, 14, 90, 'Paper', 3, '', '2022-02-02 13:10:25',30),
	(5, 11, 60, 'Paper', 2,  '','2022-02-02 16:10:25', 20),
    (5, 10, 90, 'Audiobook', 3, '','2022-02-02 15:10:25', 30),
    (6, 15, 90, 'Read-Aloud', 1,  '', '2022-02-02 11:10:25',30),
    (6, 17, 30, 'Audiobook', 1, '','2022-02-03 14:10:25', 10),
    (7, 18, 30, 'Paper', 1,  '','2022-02-03 15:10:25', 10),
    (8, 16, 30, 'Paper', 1, 'Definitely for older kids with difficult vocabulary and deep concepts.','2022-02-03 19:10:25', 10),
	(5, 7, 60, 'Paper', 2, '','2022-02-03 13:10:25', 20),
    (4, 14, 90, 'Paper', 3,  '','2022-02-03 17:10:25', 30),
    (3, 13, 90, 'Paper', 1,  '', '2022-02-04 16:10:25',30),
    (8, 12, 30, 'Audiobook', 1,  '','2022-02-04 12:10:25', 10),
	(6, 1, 30, 'Digital', 2,  'Definitely good for sleepy time.','2022-02-04 16:10:25', 10),
	(6, 5, 60, 'Read-Aloud', 1,  'Not a fan.','2022-02-04 17:10:25', 20),
	(8, 3, 60, 'Read-Aloud', 2, '','2022-02-05 13:10:25', 20),
	(6, 6, 90, 'Read-Aloud', 3,  '','2022-02-05 18:10:25', 30),
	(8, 4, 90, 'Paper', 1, '', '2022-02-05 15:10:25',30),
	(7, 8, 30, 'Paper', 1,  '', '2022-02-05 17:10:25',10),
	(7, 9, 60, 'Paper', 5,  'My favorite!!!!', '2022-02-05 14:10:25', 20),
	(8, 7, 60, 'Digital', 2, '', '2022-02-05 15:45:25', 20);
